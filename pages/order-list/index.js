...
=======
  ...
  orderListLoading(){
    ...
    util.req('/homehome/get-order-list','GET').then(e=>{
      this.orderList = e.data.data;
      var orderList = e.data.data.filter(e=>{
        if(status == 9999 ) return e;
...
=======
  ...
  openOrder(e){
    ...
    wx.navigateTo({
      url: `/pages/oderinfo/oderinfo?id=${id}`
    })
  },
  fuzhi(e){
    console.log(e)
